...
GROWABLE_NETWORK_TYPE : {'all', 'all_public', 'bike', 'drive', 'drive_service', 'walk'} 
...
_CRS_CALCULATIONS : str
    EPSG code of the coordinate reference system that is used to project osm data for calculations. Default is '3857' (WGS 84 / Pseudo-Mercator). Note that the CRS for plotting is not set here, but in settings.viz["crs"].
_PRESET_TAGS : dict
...
GROWABLE_NETWORK_CUSTOM_FILTER = [ # adapted from https://github.com/gboeing/osmnx/blob/2fc39cb2792ff869881b99f724a2d97f0e958667/osmnx/_overpass.py#L77
    ...
    '["highway"~"cycleway"]',
    '["highway"~"living_street"]',
    '["highway"~"path|pedestrian"]["bicycle"~"designated|yes|permissive"]',
    '["cyclestreet"]',
    '["cycleway"~"track"]',
    '["cycleway:right"~"track"]',
    '["cycleway:left"~"track"]',
