...
growable_network : str
    The growable network is loaded from this file. Must be a gpkg file in unprojected crs EPSG:4326 with layers nodes and edges, with the structure that an undirected osmnx street network g has after saved via ox.io.save_graph_geopackage().
bike_network : st
...
Examples
--------
>>> python batchexport_onecity.py Barcelona Barcelona_es geojson boundaries/barcelona_es.geojson growable_networks/barcelona_es.gpkg bike_networks/barcelona_es.gpkg
"""
...
growable_network = "growable_networks/barcelona_es.gpkg"
    ...
    for ordering in export_orderings:
        for existing_network_spacing in export_existing_network_spacings:
            ...
            gbn.growbikenet(
                ...
                city_id=city_id,
                import_files={"city_boundary": city_boundary, "growable_network": growable_network, "bike_network": bike_network},
            )
