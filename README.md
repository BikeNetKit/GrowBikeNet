...
> [!NOTE]  
> GrowBikeNet is currently in Beta: It is core-feature complete, stable to use, but could still contain bugs. More features and breaking changes may be added anytime. Please [let us know](https://github.com/BikeNetKit/GrowBikeNet/issues) if you find issues or ways to improve.
